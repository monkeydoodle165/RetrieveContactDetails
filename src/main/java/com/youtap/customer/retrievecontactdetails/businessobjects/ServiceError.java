...
public class ServiceError{
	...
	{
		put(Errors.NO_PARAMETERS_ENTERED_ERROR, 	"Please submit an id or name in order to search");
		put(Errors.MULTI_PARAMTERS_ENTERED_ERROR,	"Please submit an id or name, not both");
